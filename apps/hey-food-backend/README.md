...
>
> This is categorically more dangerous than every other stand-in in this repo. The payment stub, the POS device key and the notification stubs each touch one outlet's orders or one customer; this one reprices the entire business and can cancel any order. Forgetting it is not a small mistake.
>
