...
>
> This is categorically more dangerous than every other stand-in in this repo. The payment stub and the notification stubs each touch one outlet's orders or one customer; this one reprices the entire business, can cancel any order, and creates the staff accounts (with a PIN) real POS login now checks. Forgetting it is not a small mistake.
>
